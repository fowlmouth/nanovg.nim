...
solution "nanovg"
	...
	project "example_gl2"
		...
		includedirs { "src", "example", "/usr/local/include" }
		targetdir("build")
		links { "nanovg" }
		...
		configuration { "macosx" }
			links { "glfw" }
			linkoptions { "-L/usr/local/lib", "-framework OpenGL", "-framework Cocoa", "-framework IOKit", "-framework CoreVideo", "-framework Carbon" }
